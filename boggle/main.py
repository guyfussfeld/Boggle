...
#################################################################
from logic import BoggleLogic
from gui import BoggleGui
from board_randomizer import *
import os
...
class BoggleController:
    ...
    """
    def __init__(self):
        all_word_from_dict =  load_words_dict(file_path("boggle/data/dict.txt"))
...
#########################################
#extracting words from given txt file (dict.txt)
